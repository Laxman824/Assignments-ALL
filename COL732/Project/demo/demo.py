'''
python code to show analogue clock on termial with ascii art
'''
import time
import math
import os
...
while(True):
    ...
    # draw circle
    # screen = draw_circle((40, 20), 20, screen)
    # draw lines
    screen = draw_lines((40, 20), (hour_x, hour_y), screen)
    screen = draw_lines((40, 20), (minute_x, minute_y), screen)
    screen = draw_lines((40, 20), (second_x, second_y), screen)
